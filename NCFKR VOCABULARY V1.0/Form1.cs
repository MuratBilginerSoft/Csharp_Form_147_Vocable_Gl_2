...
namespace NCFKR_VOCABULARY_V1._0
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, 1368, 442, 15, 15));
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, 1369, 465, 15, 15));
        ...
        {
            label16.Text = "Seçim yaptığınız kelime grubu için tekrar eti başlatır.";
        }

        private void b16_MouseHover(object sender, EventArgs e)
        {
            label16.Text = "Bir sonraki kelimeyi gösterir.";
        }

        private void b15_MouseHover(object sender, EventArgs e)
        {
            label16.Text = "Bir önceki kelimeyi gösterir.";
        }

        private void b17_MouseHover(object sender, EventArgs e)
        {
            label16.Text = "Tekrar et bölümünü kapatıp.Kelime çalış bölümüne geçmenizi sağlar.";
        }

        private void b19_MouseHover(object sender, EventArgs e)
        {
            label16.Text = "Farklı bir kelime grubu seçmek yada çalıştığınızı tekrar etmek için durumu sıfırlar.";
        }
